  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-4 right-4 z-50 w-14 h-14 bg-orange-500 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-blue-700"
      >
